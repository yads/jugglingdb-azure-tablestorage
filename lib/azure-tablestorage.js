...
//Need https://github.com/Azure/azure-storage-node/issues/31 fixed before we can really use this
...
AzureTablestore.prototype.create = function create(model, data, callback) {
    ...
    this.client.insertEntity(this.tableName(model), data,
...
AzureTablestore.prototype.updateOrCreate = function updateOrCreate(model, data, callback) {
    ...
    this.client.insertOrReplaceEntity(this.tableName(model), data,
